        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center gap-4 bg-slate-50/80 px-4 py-2 rounded-full border border-slate-200/60 backdrop-blur-sm">
              ...
              <Link
                href="/dashboard/ar/contacts"
                className="group flex items-center justify-center w-9 h-9 rounded-full bg-white border border-slate-200 text-slate-400 hover:text-indigo-500 hover:border-indigo-100 hover:bg-indigo-50 transition-all duration-200 shadow-sm mr-2 relative"
                title="Daftar Kontak Wajib Pajak"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
